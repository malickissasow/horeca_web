...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    statDecideurs: 'Professionnels Décideurs',
    statExposants: 'Exposants Spécialisés',
    statDiplomes: 'Jeunes Diplômés HORECA',
    statHosted: 'Hosted Buyers Internationaux',
    statSpeakers: 'Speakers & Experts',
    statMeetings: 'Rendez-vous B2B Programés',
